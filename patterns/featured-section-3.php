 ...
 * Slug: patterns-lawyer/featured-section-3
...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/img-6.jpg","hasParallax":true,"dimRatio":90,"overlayColor":"secondary","minHeight":80,"minHeightUnit":"vh","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|30","right":"var:preset|spacing|30"},"blockGap":"var:preset|spacing|60"}}} -->
<div class="wp-block-cover alignfull has-parallax" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);min-height:80vh"><span aria-hidden="true" class="wp-block-cover__background has-secondary-background-color has-background-dim-90 has-background-dim"></span><div role="img" class="wp-block-cover__image-background has-parallax" style="background-position:50% 50%;background-image:url(<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/img-6.jpg)"></div><div class="wp-block-cover__inner-container">

<!-- wp:pattern {"slug":"patterns-lawyer/section-title-2"} /-->

<!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide"><!-- wp:columns {"verticalAlignment":"top","align":"wide","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|40"}}}} -->
<div class="wp-block-columns alignwide are-vertically-aligned-top"><!-- wp:column {"verticalAlignment":"top","width":"40%"} -->
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:40%">

<!-- wp:pattern {"slug":"patterns-lawyer/card-1"} /-->
</div>
<!-- /wp:column -->
...
<div class="wp-block-group">
    ...
    <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/icon-3.png" style="object-fit:contain;width:80px;"/></figure>
    <!-- /wp:image -->
</div>
<!-- /wp:group -->
...
<div class="wp-block-group">
<!-- wp:paragraph -->
<p><?php esc_html_e( 'Get Free', 'patterns-lawyer' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":4,"className":"pwp-txt-dec-non"} -->
<h4 class="wp-block-heading pwp-txt-dec-non"><a href="#"><?php esc_html_e( 'Expert Advice', 'patterns-lawyer' ); ?></a></h4>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group">
    <!-- wp:image {"width":"80px","scale":"contain","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|white"}}} -->
    <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/icon-4.png" style="object-fit:contain;width:80px;"/></figure>
    <!-- /wp:image -->
</div>
<!-- /wp:group -->
...
<div class="wp-block-group">
<!-- wp:paragraph -->
<p><?php esc_html_e( 'Pay Fee', 'patterns-lawyer' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":4,"className":"pwp-txt-dec-non"} -->
<h4 class="wp-block-heading pwp-txt-dec-non"><a href="#"><?php esc_html_e( 'Via Online', 'patterns-lawyer' ); ?></a></h4>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
