...
/**
 * Title: Post Meta
 * Slug: patterns-lawyer/post-meta
 * Categories: posts
...
<p class="has-base-color has-text-color" style="margin-bottom:0px"><?php esc_html_e( 'Posted :', 'patterns-lawyer' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group" style="font-size:14px"><!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"0px"}}},"textColor":"base"} -->
<p class="has-base-color has-text-color" style="margin-bottom:0px"><?php esc_html_e( 'by :', 'patterns-lawyer' ); ?></p>
<!-- /wp:paragraph -->
