 ...
 * Slug: patterns-lawyer/featured-section-8
...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0px","bottom":"var:preset|spacing|80"}},"border":{"bottom":{"color":"var:preset|color|quinary","style":"solid","width":"1px"},"top":[],"right":[],"left":[]}},"backgroundColor":"default","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-default-background-color has-background"
    style="border-bottom-color:var(--wp--preset--color--quinary);border-bottom-style:solid;border-bottom-width:1px;padding-top:0px;padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:columns {"verticalAlignment":"center","align":"wide","style":{"spacing":{"blockGap":{"left":"150px"}}}} -->
<div class="wp-block-columns alignwide are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"25%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:25%"><!-- wp:heading {"textAlign":"left","level":5} -->
<h5 class="wp-block-heading has-text-align-left"><?php esc_html_e( 'Over 30 Years Experience, Qualified Legal Attorneys', 'patterns-lawyer' ); ?></h5>
<!-- /wp:heading --></div>
<!-- /wp:column -->
